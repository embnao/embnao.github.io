...
// 插入即有序
extern int seqlist_insert_sort(seqlist_t *s, const void *data, cmp_t cmp);
...
// 改
extern int seqlist_update(const seqlist_t *s, const void *key, cmp_t cmp, const void *new_data);
